@extends('FrontEnd.layout.Header.header')
		...
		<div id="home" class="hero-area">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(frontEnd/img/home-background.jpg)"></div>
			<!-- /Backgound Image -->
				...
				<div id="courses-wrapper">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="frontEnd/img/course01.jpg" alt="">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="frontEnd/img/course02.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="frontEnd/img/course03.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="frontEnd/img/course04.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="frontEnd/img/course05.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="frontEnd/img/course06.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="frontEnd/img/course07.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="frontEnd/img/course08.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
		...
		<div id="cta" class="section">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(frontEnd/img/cta1-background.jpg)"></div>
			<!-- /Backgound Image -->
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-offset-1">
						<a class="about-video" href="#">
							<img src="frontEnd/img/about-video.jpg" alt="">
		...
		<div id="contact-cta" class="section">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(frontEnd/img/cta2-background.jpg)"></div>
			<!-- Backgound Image -->
